 ...
 *  - {"id":"shqkel","company":"KH정보교육원","classroom":"352","cnt":77}
 *  - 속성명은 반드시 쌍따옴표로 감싼다.
 *  - 문자열을 반드시 쌍따옴표로 감싼다.
...
document.querySelector('#btn1').addEventListener('click', () => {
    ...
    document.querySelector('#btn2').addEventListener('click', () => {
        const url = 'https://api.github.com/users/be-anything';
        fetch(url)
 ...
 * - http 요청 헤더부분에 지정한 헤더명으로 등록하게 되낟.
 */
document.querySelector('#btn5').addEventListener('click', () => {
    ...
    axios(url, {
        headers : {
            'x-api-key' : 'live_VDzutF7SC7Tt5qe35r1pF3GlAYt3bqqwaJg782NORDIxde9wqQwm34amkvIW3gdT'
        },
        params: {
            limit : 1,
            size : 'full'
